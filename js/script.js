let cardsArray = [{
        ...
        'body': '<b>Team</b> 3 backend, 2 frontend, 1 devops.<br>' +
        ...
        'footerList': 'Architecture.<br>' +
            'BackEnd core features development.<br>' +
            'Technical consultations.<br>' +
            'Troubleshooting.<br>' +
            'Interviewing new employers.<br>' +
    ...
    },
    {
        ...
        'body': '<b>Team</b> 3 backend, 3 frontend, 2 devops.<br>' +
            '<b>MoreInfo</b> <a href="https://github.com/imaxfp/blockchain-workbench-rest">https://github.com/imaxfp/blockchain-workbench-rest</a> <br>' +
            '<b>Language</b> Java / Scala<br>' +
    ...
    },
    {
        ...
        'body': '<b>Team</b> 5 backend, 4 frontend, 2 devops.<br>' +
            '<b>Language</b> Scala<br>' +
            '<b>Technologies</b> Docker, r3Corda<br>' +
            '<b>Platform</b> Cross-platform<br>' +
            '<b>Role</b> Architect / Core developer',
        'footerList': 'Architecture.<br>' +
            'BackEnd core features development.<br>' +
        ...
        'body': '<b>Team</b> 4 backend, 2 frontend, 1 devops.<br>' +
            '<b>Language</b> Python, Java<br>' +
            'Technologies and libs: <a href="https://matplotlib.org"></a>,  https://scikit-learn.org, https://www.docker.com, https://pandas.pydata.org"></a><br>' +
            '<b>Platform</b> Cross-platform<br>' +
            '<b>Role</b> Data scientist / Core developer ',
        'footerList': 'Data analyzing.<br>' +
            'Architecture.<br>' +
            'BackEnd core features development.<br>' +
            'Technical consultations.<br>' +
            'Troubleshooting. ',
        ...
        'body': '<b>Team</b> 4 backend, 2 frontend, 1 devops.<br>' +
            '<b>Language</b> Python, Java<br>' +
            'Technologies and libs: https://matplotlib.org,  https://scikit-learn.org, https://www.docker.com, https://pandas.pydata.org,<br>' +
            '<b>Platform</b> Cross-platform<br>' +
            '<b>Role</b> Data scientist / Core developer ',
        'footerList': 'Data analyzing.<br>' +
            'Architecture.<br>' +
        ...
        'body': '<b>Team</b> 5 backend, 4 frontend, 2 devops.<br>' +
            '<b>Language</b> Python / Java<br>' +
            '<b>Technologies</b> Docker, spring boot, hibernate,  sklearn, pandas, matplotlib, etc<br>' +
            '<b>Platform</b> Cross-platform<br>' +
            '<b>Role</b> Architect / Core developer ',
        'footerList': 'Architecture and development.<br>' +
            'Data analyzes.<br>' +
            'Applying ML algorithms.<br>' +
            'Training models.<br>' +
            'Troubleshooting. ',
        ...
        'headerTitle': '',
        'header': '',
        'body': '<b>Language</b> Scala<br>' +
            '<b>Technologies</b> r3Corda, Java, Docker, Postgres, Akka, Spring, ReactJS<br>' +
            '<b>Platform</b> Cross-platform<br>' +
            '<b>Role</b> CTO ',
        'footerList': 'Architecture,<br>' +
            ' BackEnd, FrontEnd, Infrastructure organization<br>' +
            ' Saving human resources(avoiding burnout in fast-changeable environment with possibility to work under pressure, etc),<br>' +
            ' Saving costs,<br>' +
            ' Interviewing new employers,<br>' +
            ' Long-term strategy of delivery,<br>' +
            ' Communicating with investor representatives,<br>' +
        ...
        'body': '<b>Team</b> 4 members of backend team, 3 members of frontend team, 2 members of mobile team, 1 member - infrastructure, 3 designers, 10 copywriters<br>' +
            '<b>MoreInfo</b> https://clubberspot.com/<br>' +
            '<b>Role</b> CTO',
        'footerList': 'Architecture.<br>' +
            'BackEnd core features development.<br>' +
            'Infrastructure deployment<br>' +
            'Troubleshooting.<br>' +
            'Preparing technical side of presentations for investors',
        'footerResult': ''
    }, {
        'headerTitle': 'Sklad#1',
        ...
        'footerResult': '<b>MoreInfo</b> https://skladn1.com/'
    }, {
        ...
        'body': '<b>Team</b> 7 developers<br>' +
            '<b>Role</b> Senior Software Engineer/ DevOps',
        'footerList': 'Architecture/Infrastructure.<br>' +
            'Migration to the Cloud.<br>' +
            'Technical consultations.',
        'footerResult': '<b>MoreInfo</b> http://www.gran-call.ru/'
    }, {
        ...
        'body': '<b>Team</b> 2 mobile developers<br>' +
            '<b>Language</b> Kotlin<br>' +
            '<b>Technologies</b> Android SDK, Coroutines, Room, Koin<br>' +
            '<b>Platform</b> Android/iOS<br>' +
            '<b>Role</b> Core developers',
        'footerList': 'Architecture.<br>' +
            'XMPP messaging.<br>' +
            'Bluetooth messaging.',
        'footerResult': ''
        ...
        'body': '<b>Team</b> 2 mobile developers<br>' +
            '<b>Language</b> Kotlin<br>' +
            '<b>Technologies</b> gRPC, RX Android, Room, Koin<br>' +
            '<b>Platform</b> Android/iOS<br>' +
            '<b>Role</b> Core developers',
        'footerList': 'Security features.<br>' +
            'File sharing.',
        'footerResult': ''
    }, {
        'headerTitle': 'Mobile client for private taxi service',
        'header': 'Rider/Driver apps, food delivery, navigation',
        'body': '<b>Team</b> 5 mobile developers<br>' +
            '<b>Language</b> Java<br>' +
            '<b>Technologies</b> RX Android, SQLite, Eventbus, Google Maps Api<br>' +
        ...
        'body': '<b>Team</b> 5 mobile developers<br>' +
            '<b>Language</b> Java<br>' +
            '<b>Technologies</b> RX Android, Dagger 2, Mockito<br>' +
            '<b>Platform</b> Android<br>' +
            '<b>Role</b> Core developers',
        'footerList': 'Full refactoring of old app<br>' +
...
const card = ({ headerTitle, header, body, footerList, footerResult }) => {
    ...
    return `<div class="col-lg-4 col-md-6 col-sm-12 mt-4 align-items-stretchs d-flex">
