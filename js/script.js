let cardsArray = [{
        ...
        'footerList': 'Architecture.' +
            'BackEnd core features development.' +
            'Technical consultations.' +
            'Troubleshooting. ' +
            'Interviewing new employers. ' +
    ...
    },
    {
        ...
        'body': 'Team: 4 backend, 2 frontend, 1 devops. ' +
            ...
            'Technologies and libs: https://matplotlib.org,  https://scikit-learn.org, https://www.docker.com, https://pandas.pydata.org, ' +
            'Platform: Cross-platform' +
            'Role: Data scientist / Core developer ',
        'footerList': 'Data analyzing.  ' +
            'Architecture.' +
            'BackEnd core features development.' +
            'Technical consultations.' +
            'Troubleshooting. ',
        ...
        'body': 'Team: 5 backend, 4 frontend, 2 devops. ' +
            ...
            'Platform: Cross-platform' +
            'Role: Architect / Core developer ',
        'footerList': 'Architecture and development.  ' +
            'Data analyzes.' +
        ...
        'body': 'Language: Scala  ' +
            ...
            'Role: CTO ',
        'footerList': 'Architecture,' +
            ' BackEnd, FrontEnd, Infrastructure organization' +
            ' Saving human resources(avoiding burnout in fast-changeable environment with possibility to work under pressure, etc),' +
            ' Saving costs,' +
            ' Interviewing new employers,' +
            ' Long-term strategy of delivery,' +
            ' Communicating with investor representatives,' +
        ...
        'body': 'Team: 4 members of backend team, 3 members of frontend team, 2 members of mobile team, 1 member - infrastructure, 3 designers, 10 copywriters' +
            'MoreInfo: https://clubberspot.com/' +
            'Role: CTO',
        'footerList': 'Architecture.' +
            'BackEnd core features development.' +
        ...
        'body': 'Team: 5 mobile developers ' +
            ...
            'Platform: Android' +
            'Role: Core developers',
        'footerList': 'Full refactoring of old app' +
